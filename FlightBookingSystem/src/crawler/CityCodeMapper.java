...
public class CityCodeMapper {
    ...
    static {
        ...
        DOMESTIC_MAPPINGS.put("iob", "Unknown (IOB)"); // Code included in list but rare/non-standard
        ...
        DOMESTIC_MAPPINGS.put("shg", "Shanghai (Generic)"); // Likely generic code
        ...
        INTERNATIONAL_MAPPINGS.put("nrt", "Tokyo (Narita)");
        INTERNATIONAL_MAPPINGS.put("hnd", "Tokyo (Haneda)");
        INTERNATIONAL_MAPPINGS.put("sel", "Seoul");
        INTERNATIONAL_MAPPINGS.put("icn", "Seoul (Incheon)");
        INTERNATIONAL_MAPPINGS.put("gmp", "Seoul (Gimpo)");
        INTERNATIONAL_MAPPINGS.put("osa", "Osaka");
        INTERNATIONAL_MAPPINGS.put("kix", "Osaka (Kansai)");
        INTERNATIONAL_MAPPINGS.put("sin", "Singapore");
        INTERNATIONAL_MAPPINGS.put("bkk", "Bangkok");
        INTERNATIONAL_MAPPINGS.put("dmk", "Bangkok (Don Mueang)");
        ...
        INTERNATIONAL_MAPPINGS.put("lhr", "London (Heathrow)");
        INTERNATIONAL_MAPPINGS.put("lgw", "London (Gatwick)");
        INTERNATIONAL_MAPPINGS.put("par", "Paris");
        INTERNATIONAL_MAPPINGS.put("cdg", "Paris (Charles de Gaulle)");
        ...
        INTERNATIONAL_MAPPINGS.put("fco", "Rome (Fiumicino)");
        ...
        INTERNATIONAL_MAPPINGS.put("jfk", "New York (JFK)");
        INTERNATIONAL_MAPPINGS.put("ewr", "New York (Newark)");
        ...
        INTERNATIONAL_MAPPINGS.put("ord", "Chicago (O'Hare)");
