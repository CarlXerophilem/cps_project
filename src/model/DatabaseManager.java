...
public class DatabaseManager {
    ...
    public boolean insertBooking(Booking booking) {
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(insertSQL)) {
            ...
            FlightData flightDataTransport = new FlightData();
            ...
            pstmt.setString(5, flightDataTransport.getAirline());
            pstmt.setString(6, flightDataTransport.getOrigin());
            pstmt.setString(7, flightDataTransport.getDestination());
            pstmt.setDate(8, Date.valueOf(flight.getDepartureDate()));
            pstmt.setTime(9, Time.valueOf(flightDataTransport.getDepartureTime()));
            pstmt.setTime(10, Time.valueOf(flightDataTransport.getArrivalTime()));
            pstmt.setString(11, booking.getPaymentMethod());
            pstmt.setDouble(12, flightDataTransport.getPrice());
